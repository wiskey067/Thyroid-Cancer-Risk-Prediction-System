...
<style>
    ...
    div[data-testid="metric-container"] [data-testid="stMetricLabel"] {
        ...
        color: #000000 !important;  /* Changed from #555555 to #000000 for black */
    }
    ...
    div[data-testid="stSidebar"] .stSlider [type="range"] {
        color: #000000 !important;
...
if predict_btn:
    ...
    with rc1:
        st.markdown('<div style="color:#000000;">Malignancy Probability</div>', unsafe_allow_html=True)
        st.metric("", f"{probability:.1%}")
    with rc2:
        st.markdown('<div style="color:#000000;">Classification</div>', unsafe_allow_html=True)
        st.metric("", "Malignant" if prediction == 1 else "Benign")
    with rc3:
        st.markdown('<div style="color:#000000;">Threshold Applied</div>', unsafe_allow_html=True)
        st.metric("", f"{threshold:.2f}")
...
""", unsafe_allow_html=True)
    ...
    st.markdown(
        "<p style='font-size:0.8rem;font-weight:700;color:#111111;"
